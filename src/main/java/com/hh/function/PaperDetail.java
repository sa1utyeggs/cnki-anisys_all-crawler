...
public class PaperDetail {
    ...
    private static Map<String, Object> getPaperDetail(String key) throws Exception {
        ...
        Document document = HttpConnectionPoolUtil.get(Const.BASE_URL + "/kcms/detail/detail.aspx?" + key, null, EXCESS_HEADERS);
...
//        Document document = connection.get();
    ...
    private static List<String> getPaperDetailKey(String metabolite, String disease, String type, int maxKeyNum) throws Exception {
        ...
        do {
            // 获得 主页面的 connection
            Document document = getPaperGridDocument(metabolite, disease, currentPage, sqlVal, handlerId, type);
    ...
    public static Document getPaperGridDocument(String metabolite, String disease, Integer curPage, String searchSql, Integer handlerId, String type) throws Exception {
        // 读出 json 字符串
        String jsonString;
