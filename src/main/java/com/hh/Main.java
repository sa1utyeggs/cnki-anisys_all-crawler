...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        insertPaperInfo("尼古丁", "结肠癌","KY", true);
    }
     ...
     * @throws IOException
     */
    public static List<String> getPaperDetailKey(String metabolite, String disease,String type) throws Exception {
        int currentPage = 1;
        int pages = 1;
        String sqlVal = "";
        int handlerId = 0;
    ...
    public static Connection getPaperGridConnection(String metabolite, String disease, Integer curPage, String searchSql, Integer handlerId,String type) {
        // 读出 json 字符串
